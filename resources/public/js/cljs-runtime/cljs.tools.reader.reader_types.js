...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_15460 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_15460(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_15468 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_15468(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15473 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_15473(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15480 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_15480(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_15484 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_15484(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15493 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_15493(reader);
}
});
...
var G__15583 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__15584 = s.append(c);
c = G__15583;
s = G__15584;
continue;
}
