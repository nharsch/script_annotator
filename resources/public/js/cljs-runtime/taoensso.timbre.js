...
var no_stacktrace_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21997__$1,new cljs.core.Keyword(null,"no-stacktrace?","no-stacktrace?",1701072694));
var stacktrace_fonts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21997__$1,new cljs.core.Keyword(null,"stacktrace-fonts","stacktrace-fonts",830799382));
var map__21998 = data;
var map__21998__$1 = cljs.core.__destructure_map(map__21998);
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21998__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var _QMARK_err = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21998__$1,new cljs.core.Keyword(null,"?err","?err",549653299));
var msg_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21998__$1,new cljs.core.Keyword(null,"msg_","msg_",-1925147000));
var _QMARK_ns_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21998__$1,new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966));
var _QMARK_file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21998__$1,new cljs.core.Keyword(null,"?file","?file",1533429675));
var hostname_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21998__$1,new cljs.core.Keyword(null,"hostname_","hostname_",-2091647379));
var timestamp_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21998__$1,new cljs.core.Keyword(null,"timestamp_","timestamp_",-954533417));
var _QMARK_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21998__$1,new cljs.core.Keyword(null,"?line","?line",-631853385));
...
/** @this {Function} */
(taoensso.timbre.swap_config_BANG_.cljs$lang$applyTo = (function (seq22016){
var G__22017 = cljs.core.first(seq22016);
var seq22016__$1 = cljs.core.next(seq22016);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22017,seq22016__$1);
}));
...
var or__5045__auto__ = (taoensso.timbre._levels_set.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_set.cljs$core$IFn$_invoke$arity$1(x) : taoensso.timbre._levels_set.call(null,x));
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
return ((function (){var G__22037 = taoensso.timbre.valid_level(x);
return (taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1(G__22037) : taoensso.timbre._levels_map.call(null,G__22037));
})() >= (function (){var G__22040 = taoensso.timbre.valid_level(y);
return (taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1 ? taoensso.timbre._levels_map.cljs$core$IFn$_invoke$arity$1(G__22040) : taoensso.timbre._levels_map.call(null,G__22040));
})());
});
...
var fexpr__22045 = taoensso.timbre._compile_ns_filter(whitelist,blacklist);
return (fexpr__22045.cljs$core$IFn$_invoke$arity$1 ? fexpr__22045.cljs$core$IFn$_invoke$arity$1(_QMARK_ns) : fexpr__22045.call(null,_QMARK_ns));
}));
/**
...
var vec__22070 = vargs;
var v0 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22070,(0),null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__22077 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22077,(0),null);
return v0__$1;
})():null);
...
var _QMARK_msg_fmt = (cljs.core.truth_(fmt_msg_QMARK_)?(function (){var vec__22089 = vargs__$1;
var v0__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22089,(0),null);
return v0__$1;
})():null);
var vargs__$2 = (cljs.core.truth_(fmt_msg_QMARK_)?taoensso.timbre.vrest(vargs__$1):vargs__$1);
...
var instant_22233 = taoensso.encore.now_dt();
var context_22234 = taoensso.timbre._STAR_context_STAR_;
var vargs_22235 = cljs.core.deref(vargs_);
var vec__22118_22236 = taoensso.timbre.parse_vargs(_QMARK_err,msg_type,vargs_22235);
var _QMARK_err_22237__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22118_22236,(0),null);
var _QMARK_meta_22238 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22118_22236,(1),null);
var _QMARK_msg_fmt_22239 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22118_22236,(2),null);
var vargs_22240__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22118_22236,(3),null);
var data_22241 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__5045__auto__ = _QMARK_base_data;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return cljs.core.PersistentArrayMap.EMPTY;
}
})(),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"instant","instant",655498374),new cljs.core.Keyword(null,"config","config",994861415),new cljs.core.Keyword(null,"vargs","vargs",-966597273),new cljs.core.Keyword(null,"?file","?file",1533429675),new cljs.core.Keyword(null,"error-level?","error-level?",778415885),new cljs.core.Keyword(null,"?ns-str","?ns-str",2012733966),new cljs.core.Keyword(null,"level","level",1290497552),new cljs.core.Keyword(null,"?err","?err",549653299),new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"?line","?line",-631853385),new cljs.core.Keyword(null,"?err_","?err_",789480858),new cljs.core.Keyword(null,"?meta","?meta",-793560773),new cljs.core.Keyword(null,"?msg-fmt","?msg-fmt",-852453891)],[instant_22233,config,vargs_22240__$1,_QMARK_file,(function (){var fexpr__22122 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"fatal","fatal",1874419888),null,new cljs.core.Keyword(null,"error","error",-978969032),null], null), null);
return (fexpr__22122.cljs$core$IFn$_invoke$arity$1 ? fexpr__22122.cljs$core$IFn$_invoke$arity$1(level) : fexpr__22122.call(null,level));
})(),_QMARK_ns_str,level,_QMARK_err_22237__$1,context_22234,_QMARK_line,(new cljs.core.Delay((function (){
return _QMARK_err_22237__$1;
}),null)),_QMARK_meta_22238,_QMARK_msg_fmt_22239]));
var _QMARK_data_22242 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,mf){
...
}),data_22241,new cljs.core.Keyword(null,"middleware","middleware",1462115504).cljs$core$IFn$_invoke$arity$1(config));
var temp__5804__auto___22250 = _QMARK_data_22242;
if(cljs.core.truth_(temp__5804__auto___22250)){
var data_22251__$1 = temp__5804__auto___22250;
var map__22128_22252 = data_22251__$1;
var map__22128_22253__$1 = cljs.core.__destructure_map(map__22128_22252);
var vargs_22254__$2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22128_22253__$1,new cljs.core.Keyword(null,"vargs","vargs",-966597273));
var data_22256__$2 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data_22251__$1,new cljs.core.Keyword(null,"vargs_","vargs_",552132148),(new cljs.core.Delay((function (){
return vargs_22254__$2;
}),null)));
var data_22257__$3 = taoensso.encore.assoc_nx.cljs$core$IFn$_invoke$arity$variadic(data_22256__$2,new cljs.core.Keyword(null,"msg_","msg_",-1925147000),(new cljs.core.Delay((function (){
var G__22130 = msg_type;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__22130)){
return "";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"p","p",151049309),G__22130)){
return taoensso.timbre.str_join(vargs_22254__$2);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),G__22130)){
if(typeof _QMARK_msg_fmt_22239 === 'string'){
} else {
...
return taoensso.encore.format_STAR_(_QMARK_msg_fmt_22239,vargs_22254__$2);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__22130)].join('')));
...
return cljs.core.hash(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [callsite_id,_QMARK_msg_fmt_22239,cljs.core.get.cljs$core$IFn$_invoke$arity$3(_QMARK_meta_22238,new cljs.core.Keyword(null,"hash","hash",-13781596),vargs_22254__$2)], null));
}),null))], 0));
var output_fn1_22258 = taoensso.encore.memoize_(cljs.core.get.cljs$core$IFn$_invoke$arity$3(config,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),taoensso.timbre.default_output_fn));
...
if(cljs.core.truth_(and__5043__auto__)){
return taoensso.timbre.level_GT__EQ_(level,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"min-level","min-level",1634684919).cljs$core$IFn$_invoke$arity$1(appender);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
return cljs.core.not((function (){var G__22140 = cljs.core.force(new cljs.core.Keyword(null,"hash_","hash_",-827203612).cljs$core$IFn$_invoke$arity$1(data_22257__$3));
return (rl_fn.cljs$core$IFn$_invoke$arity$1 ? rl_fn.cljs$core$IFn$_invoke$arity$1(G__22140) : rl_fn.call(null,G__22140));
})());
}
})();
if(rate_limit_okay_QMARK_){
var map__22141 = appender;
var map__22141__$1 = cljs.core.__destructure_map(map__22141);
var apfn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22141__$1,new cljs.core.Keyword(null,"fn","fn",-1175266204));
var async_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22141__$1,new cljs.core.Keyword(null,"async?","async?",1523057758));
...
return output_fn1_22258;
} else {
return f;
}
})();
var output_ = (new cljs.core.Delay((function (){
return (output_fn.cljs$core$IFn$_invoke$arity$1 ? output_fn.cljs$core$IFn$_invoke$arity$1(data_22257__$3) : output_fn.call(null,data_22257__$3));
}),null));
var data__$4 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(data_22257__$3,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"appender-id","appender-id",-1917983538),id,new cljs.core.Keyword(null,"appender","appender",1267426510),appender,new cljs.core.Keyword(null,"output-fn","output-fn",1600951539),output_fn,new cljs.core.Keyword(null,"output_","output_",-36797880),output_], null));
...
var args__5775__auto__ = [];
var len__5769__auto___22276 = arguments.length;
var i__5770__auto___22277 = (0);
while(true){
if((i__5770__auto___22277 < len__5769__auto___22276)){
args__5775__auto__.push((arguments[i__5770__auto___22277]));

var G__22278 = (i__5770__auto___22277 + (1));
i__5770__auto___22277 = G__22278;
continue;
} else {
}
break;
...
/** @this {Function} */
(taoensso.timbre.str_println.cljs$lang$applyTo = (function (seq22162){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq22162));
}));
