...
var G__25746 = o;
reagent.impl.template.goog$module$goog$object.set(G__25746,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__25764__delegate = function (args){
...
while (G__25765__i < G__25765__a.length) {G__25765__a[G__25765__i] = arguments[G__25765__i + 0]; ++G__25765__i;}
  args = new cljs.core.IndexedSeq(G__25765__a,0,null);
} 
return G__25764__delegate.call(this,args);};
G__25764.cljs$lang$maxFixedArity = 0;
G__25764.cljs$lang$applyTo = (function (arglist__25766){
var args = cljs.core.seq(arglist__25766);
return G__25764__delegate(args);
});
...
var G__25747 = o;
reagent.impl.template.goog$module$goog$object.set(G__25747,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__25748 = props;
var G__25748__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25748,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25748);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25748__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__25749 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25749,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__25749;
}
})(),id_class);
...
var G__25750 = (cljs.core.count(argv) - first_child);
switch (G__25750) {
case (0):
...
var vec__25751 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25751,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25751,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25751,(2),null);
...
var temp__5808__auto___25781 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___25781 == null)){
} else {
var key_25782 = temp__5808__auto___25781;
(jsprops.key = key_25782);
}
...
var temp__5808__auto___25784 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___25784 == null)){
} else {
var key_25785 = temp__5808__auto___25784;
(jsprops.key = key_25785);
}
...
var temp__5808__auto___25787 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___25787 == null)){
} else {
var key_25788 = temp__5808__auto___25787;
(jsprops.key = key_25788);
}
...
var temp__5808__auto___25801 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___25801 == null)){
} else {
var key_25802 = temp__5808__auto___25801;
(jsprops.key = key_25802);
}
...
var temp__5808__auto___25803 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___25803 == null)){
} else {
var key_25804 = temp__5808__auto___25803;
(jsprops.key = key_25804);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25754_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__25754_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__25755 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25755,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25755,(1),null);
...
break;
default:
var G__25821 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__25822 = compiler;
v = G__25821;
compiler = G__25822;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template25761 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template25761 = (function (opts,id,fn_to_element,parse_fn,meta25762){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template25761.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_25763,meta25762__$1){
var self__ = this;
var _25763__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template25761(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta25762__$1));
}));

(reagent.impl.template.t_reagent$impl$template25761.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_25763){
var self__ = this;
var _25763__$1 = this;
return self__.meta25762;
}));

(reagent.impl.template.t_reagent$impl$template25761.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template25761.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template25761.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template25761.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template25761.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template25761.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta25762","meta25762",259348191,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template25761.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template25761.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template25761");

(reagent.impl.template.t_reagent$impl$template25761.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template25761");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template25761.
 */
reagent.impl.template.__GT_t_reagent$impl$template25761 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template25761(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta25762){
return (new reagent.impl.template.t_reagent$impl$template25761(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta25762));
});

}

return (new reagent.impl.template.t_reagent$impl$template25761(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
