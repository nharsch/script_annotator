...
com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_ = (function com$fulcrologic$fulcro$algorithms$indexing$index_query_STAR_(prop__GT_classes,p__26435){
var map__26436 = p__26435;
var map__26436__$1 = cljs.core.__destructure_map(map__26436);
var ast = map__26436__$1;
var parent_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26436__$1,new cljs.core.Keyword(null,"component","component",1555936782));
var parent_children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26436__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (idx,p__26440){
var map__26442 = p__26440;
var map__26442__$1 = cljs.core.__destructure_map(map__26442);
var child_ast = map__26442__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26442__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var dispatch_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26442__$1,new cljs.core.Keyword(null,"dispatch-key","dispatch-key",733619510));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26442__$1,new cljs.core.Keyword(null,"children","children",-940561982));
var G__26444 = idx;
var G__26444__$1 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__26444,dispatch_key,parent_key):G__26444);
var G__26444__$2 = ((((cljs.core.vector_QMARK_(key)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),cljs.core.second(key)))))?update_index(G__26444__$1,key,parent_key):G__26444__$1);
var G__26444__$3 = (((key instanceof cljs.core.Keyword))?update_index(G__26444__$2,key,parent_key):G__26444__$2);
if(cljs.core.seq(children)){
return (com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.cljs$core$IFn$_invoke$arity$2(G__26444__$3,child_ast) : com.fulcrologic.fulcro.algorithms.indexing.index_query_STAR_.call(null,G__26444__$3,child_ast));
} else {
return G__26444__$3;
}
...
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26452__$1,new cljs.core.Keyword(null,"children","children",-940561982));
 ...
 */
com.fulcrologic.fulcro.algorithms.indexing.link_query_props = (function com$fulcrologic$fulcro$algorithms$indexing$link_query_props(p__26460){
var map__26461 = p__26460;
var map__26461__$1 = cljs.core.__destructure_map(map__26461);
var ast = map__26461__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26461__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26461__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
}),null)),null,1086695276);

var map__26471 = app;
var map__26471__$1 = cljs.core.__destructure_map(map__26471);
var state_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26471__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","state-atom","com.fulcrologic.fulcro.application/state-atom",648128366));
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26471__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var map__26472 = cljs.core.deref(runtime_atom);
var map__26472__$1 = cljs.core.__destructure_map(map__26472);
var root_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26472__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","root-class","com.fulcrologic.fulcro.application/root-class",-719803119));
...
var map__26483 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__26483__$1 = cljs.core.__destructure_map(map__26483);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26483__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
...
var map__26507 = com.fulcrologic.fulcro.raw.components.any__GT_app(this$);
var map__26507__$1 = cljs.core.__destructure_map(map__26507);
var runtime_atom = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26507__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.application","runtime-atom","com.fulcrologic.fulcro.application/runtime-atom",-1167397772));
var cls = com.fulcrologic.fulcro.raw.components.component_type(this$);
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"action","action",-811238024),(function com$fulcrologic$fulcro$algorithms$indexing$action(p__26520){
var map__26521 = p__26520;
var map__26521__$1 = cljs.core.__destructure_map(map__26521);
var app = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26521__$1,new cljs.core.Keyword(null,"app","app",-560961707));
var _STAR_after_render_STAR__orig_val__26523_26550 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__26524_26551 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__26524_26551);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__26523_26550);
}
return null;
}),new cljs.core.Keyword(null,"result-action","result-action",-1254630246),(function (env){
var _STAR_after_render_STAR__orig_val__26527 = com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_;
var _STAR_after_render_STAR__temp_val__26528 = true;
(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__temp_val__26528);
...
}finally {(com.fulcrologic.fulcro.raw.components._STAR_after_render_STAR_ = _STAR_after_render_STAR__orig_val__26527);
}})], null);
}));
