 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__23693){
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__23698){
var vec__23699 = p__23698;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23699,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23699,(1),null);
var ref = vec__23699;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__23705){
var map__23706 = p__23705;
var map__23706__$1 = cljs.core.__destructure_map(map__23706);
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23706__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__23718,entity,state_map,parent_node,idents_seen){
var map__23719 = p__23718;
var map__23719__$1 = cljs.core.__destructure_map(map__23719);
var join_node = map__23719__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23719__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23719__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$10(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"warn","warn",-436710552),"com.fulcrologic.fulcro.algorithms.denormalize",null,110,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$10(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"warn","warn",-436710552),"com.fulcrologic.fulcro.algorithms.denormalize",null,126,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay((function (){
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__23760,entity,state_map,idents_seen){
var map__23762 = p__23760;
var map__23762__$1 = cljs.core.__destructure_map(map__23762);
var join_node = map__23762__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23762__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__23764){
var map__23765 = p__23764;
var map__23765__$1 = cljs.core.__destructure_map(map__23765);
var node = map__23765__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23765__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
...
var vec__23775 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23775,(0),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var e = temp__5802__auto__;
var temp__5802__auto____$1 = (function (){var G__23783 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__23783) : union_key__GT_query.call(null,G__23783));
})();
if(cljs.core.truth_(temp__5802__auto____$1)){
var target_ast_node = temp__5802__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__23785,current_entity,state_map,idents_seen){
var map__23786 = p__23785;
var map__23786__$1 = cljs.core.__destructure_map(map__23786);
var top_node = map__23786__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23786__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23786__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__23787 = nil_nodes;
var G__23787__$1 = (((G__23787 == null))?null:cljs.core.first(G__23787));
if((G__23787__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__23787__$1);
}
})());
} else {
return and__5043__auto__;
...
var G__23788 = result_node__$1;
var G__23788__$1 = (((G__23788 == null))?null:cljs.core.persistent_BANG_(G__23788));
if((G__23788__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__23788__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__23789 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__23789 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__23789,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__23792 = props;
var G__23792__$1 = (((G__23792 == null))?null:cljs.core.meta(G__23792));
if((G__23792__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__23792__$1);
}
});
/**
...
var _STAR_root_keys_and_idents_STAR__orig_val__23793 = com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_;
var _STAR_root_keys_and_idents_STAR__temp_val__23794 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.transient$(cljs.core.PersistentHashSet.createAsIfByAssoc([root_key_or_ident])));
(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__temp_val__23794);
...
}finally {(com.fulcrologic.fulcro.algorithms.denormalize._STAR_root_keys_and_idents_STAR_ = _STAR_root_keys_and_idents_STAR__orig_val__23793);
}});
/**
...
var map__23798 = cljs.core.meta(prior_props);
var map__23798__$1 = cljs.core.__destructure_map(map__23798);
var visited = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23798__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","visited","com.fulcrologic.fulcro.algorithms.denormalize/visited",823384252));
var source_state_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23798__$1,new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","source-state-map","com.fulcrologic.fulcro.algorithms.denormalize/source-state-map",-1097808870));
